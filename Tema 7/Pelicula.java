...
class Pelicula {
    ...
    //Constructor que descompone la línea del archivo e introduce los datos en los atrubutos correspondientes        titulo = tit;
        String [] palabras = linea.split(";"); //Descompongo la línea
    
        //Meto cada elemento en su atributo correspondiente
        titulo = palabras[0];
        director = palabras[1];
        genero = palabras[2];
        duracion = Integer.parseInt(palabras[3]);
        nacionalidad = palabras[4];
        year = Integer.parseInt(palabras[5]);
    }
    ...
    //Defino el resto de métodos
     ...
     public String cadenaFichero() {
        return titulo+";"+director+";"+genero+";"+duracion+";"+nacionalidad+";"+year;
     }
