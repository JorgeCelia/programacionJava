...
public class VentanaHBoxLayout extends JFrame implements ActionListener {
    JButton ejCheckBox, ejRadioButton, ejScrollBar, ejSlider, ejList, ejListaCombinada, ejColor, ejFile, ejMenu, ejMenuContextual;

    public VentanaHBoxLayout() { 
        super("Ejemplo de Layout Box Horizontal"); 
        setSize(600,500);
