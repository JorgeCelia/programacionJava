...
public class VentanaFlowLayout extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        VentanaFlowLayout ventanaFL = new VentanaFlowLayout();
        JPanel jp=new JPanel(false); 
        jp.setLayout(new FlowLayout());

        ventanaFL.setContentPane(jp);

        // 2. Configurar el comportamiento al cerrar la ventana
        ventanaFL.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        // 3. Creamos una nueva ventana con los elementos definidos más arriba
        ventanaFL.VentanaActual();
