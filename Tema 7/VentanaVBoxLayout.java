...
public class VentanaVBoxLayout extends JFrame implements ActionListener {
    JButton ejCheckBox, ejRadioButton, ejScrollBar, ejSlider, ejList, ejListaCombinada, ejColor, ejFile, ejMenu, ejMenuContextual;

    public VentanaVBoxLayout() { 
        super("Ejemplo de Layout Box Vertical"); 
        setSize(600,500);
