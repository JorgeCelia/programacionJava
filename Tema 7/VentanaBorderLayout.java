...
public class VentanaBorderLayout extends JFrame implements ActionListener {
    ...
    public void VentanaActual(){ 
        ...
        getContentPane().add(ejListaCombinada, BorderLayout.CENTER);
        ...
        getContentPane().add(ejColor, BorderLayout.NORTH);
        ...
        getContentPane().add(ejFile, BorderLayout.WEST);
        ...
        getContentPane().add(ejMenu, BorderLayout.EAST);
        ...
        getContentPane().add(ejMenuContextual, BorderLayout.SOUTH);
    ...
    public static void main(String[] args) {
        ...
        VentanaBorderLayout ventanaBL = new VentanaBorderLayout();
        JPanel jp=new JPanel(false); 
        jp.setLayout(new BorderLayout(4,3));

        ventanaBL.setContentPane(jp);

        // 2. Configurar el comportamiento al cerrar la ventana
        ventanaBL.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        // 3. Creamos una nueva ventana con los elementos definidos más arriba
        ventanaBL.VentanaActual();
