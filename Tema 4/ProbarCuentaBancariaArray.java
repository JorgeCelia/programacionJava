...
class ProbarCuentaBancariaArray {
   ...
   public static void main(String[] args) {
    ...
    //int serie[] = new int[5];
      ...
      cuentas[0] = new CuentaBancaria("Cajamar","ES9012341234123412341234", 1500, "Pepa", "Rodriguez Perez", "45123123U");
      cuentas[1] = new CuentaBancaria("BBVA","ES9044441234888812341234", 1500, "Luis", "Garcia Lopez", "76111999T");
      cuentas[2] = new CuentaBancaria("Bankinter","ES9012888834123412341234", 1500, "Luisa", "Hernandez Hernandez", "00883123F");
      cuentas[3] = new CuentaBancaria("Unicaja","ES9012341234876542341234", 1500, "Tomás", "Garcia Felices", "56189123J");
      cuentas[4] = new CuentaBancaria("Santander","ES901234112234412341234", 1500, "Andrés", "López Sánchez", "89712321P");
