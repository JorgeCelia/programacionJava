    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("botonInsertar")) { //Ha pedido insertar una nueva película
            ...
            if (campoTitulo.getText().equals("") || campoDirector.getText().equals("") || campoGenero.getText().equals("") || campoDuracion.getText().equals("") || campoPais.getText().equals("") || campoYear.getText().equals("")) { 
                ...
                //Creo un objeto pelicula con los datos pasados
                Pelicula p = new Pelicula();

                p.setTitulo(campoTitulo.getText());
                p.setDirector(campoDirector.getText());
                p.setGenero(campoGenero.getText());
                p.setDuracion(Integer.parseInt(campoDuracion.getText()));
                p.setNacionalidad(campoPais.getText());
                p.setYear(Integer.parseInt(campoYear.getText()));

                //Se lo paso al método que inserta nueva películas
                exito=gestor.insertaPelicula(p);
